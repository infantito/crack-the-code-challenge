interface RutaDetailLearning {
  title: string
  description: string
}

interface RutaDetailFaq {
  question: string
  answer: string
}

interface RutaDetailCourse {
  id: number
  groups: any[]
  thumbnail: string
  cover: string
  final_project_cover: any
...
interface RutaDetailResponse {
  id: number
  courses: RutaDetailCourse[]
  faqs: RutaDetailFaq[]
  level: number
  number_of_sessions: number
  next_learning_paths: any[]
  ...
  has_seo_noindex: boolean
  next_learning_path: any
  age_range_v2: number[]
}

export type { RutaDetailCourse, RutaDetailFaq, RutaDetailLearning, RutaDetailResponse }
